    ...
    async function addFundraisers(factory, count, accounts) {
        ...
        for (let i=0; i < count; i++) {
            await factory.createFundraiser(
                // インデックスを利用しつつ、一連の Fundraiser インスタンスを作成することで、それぞれを区別
                `${name} ${i}`,
                `${lowerCaseName}${i}.com`,
                `${lowerCaseName}${i}.png`,
